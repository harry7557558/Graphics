...
class Restormer(nn.Module):
    ...
    def __init__(self, channels: int=3, dim: int=4, ffn_expansion_factor: float=2.0, num_refinement_blocks: int=4):
...
# python3 train_03.py --image_directory ~/adr/coco/df2k
