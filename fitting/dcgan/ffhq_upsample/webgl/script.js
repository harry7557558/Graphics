...
function loadModel() {
    ...
    loadWeightTexture(path + "/w01_256_32.bin", "w01");
    loadWeightTexture(path + "/w02_16_16_3_3.bin", "w02");
    loadWeightTexture(path + "/w03_16_16_3_3.bin", "w03");
    loadWeightTexture(path + "/w04_8_16_5_5.bin", "w04");
    loadWeightTexture(path + "/w05_3_8_5_5.bin", "w05");
}
