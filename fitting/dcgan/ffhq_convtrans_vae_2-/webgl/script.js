...
function Conv2d311(
    ...
    this.forward = function(buffer_in, buffer_out) {
        ...
        let gl = renderer.gl;
        let program = renderer.programConv2d311;
        ...
        for (var i = 0; i < this.n_out; i += 4) {
            ...
            for (var j = 0; j < this.n_in; j += 4) {
                ...
                gl.uniform1i(gl.getUniformLocation(program, 'tileSize'), this.tile_size);
...
async function drawScene() {
    ...
    var initial = new Float32Array(64*4*ny*4*nx);
    for (var gi = 0; gi < nx; gi++) {
        for (var gj = 0; gj < ny; gj++) {
            ...
            // linear - (32) => (768)
            var layer1js = new Array(768).fill(0.0);
            let w01 = renderer.w01_768_32;
            let b01 = renderer.b01_768;
            for (var i = 0; i < 768; i++) {
                layer1js[i] = b01[i];
                for (var j = 0; j < 32; j++)
    ...
    r.relu5.forward(r.layer5, r.layer5a);
    r.conv6.forward(r.layer5a, r.layer6);
    r.relu6.forward(r.layer6, r.layer6a);
    r.conv7.forward(r.layer6a, r.layer7);
    r.relu7.forward(r.layer7, r.layer7a);
    r.conv8.forward(r.layer7a, r.layer8);
    ...
    gl.activeTexture(gl.TEXTURE0);
    gl.bindTexture(gl.TEXTURE_2D, r.layer8.imgs[0].texture);
...
// load model
function loadModel() {
    loadWeightTexture("w01_768_32", "w01");
    loadWeightTexture("b01_768", "b01");
    loadWeightTexture("w02_64_48_3_3", "w02");
    loadWeightTexture("b02_64", "b02");
    loadWeightTexture("w03_64_64_4_4", "w03");
    loadWeightTexture("b03_64", "b03");
    loadWeightTexture("w04_64_64_4_4", "w04");
    loadWeightTexture("b04_64", "b04");
    loadWeightTexture("w05_64_64_4_4", "w05");
    loadWeightTexture("b05_64", "b05");
    loadWeightTexture("w06_64_48_4_4", "w06");
    loadWeightTexture("b06_48", "b06");
    loadWeightTexture("w07_32_48_3_3", "w07");
    loadWeightTexture("b07_32", "b07");
    loadWeightTexture("w08_3_32_3_3", "w08");
}
...
function updateModel() {
    ...
    let ny = Math.floor(canvas.height / 64);
    let n = [nx, ny];
    r.layer1 = new CNNBuffer(48, 4*nx, 4*ny);
    r.conv2 = new Conv2d311(n, 4, 48, 64, r.w02_64_48_3_3, r.b02_64);
    r.layer2 = new CNNBuffer(64, 4*nx, 4*ny);
    r.relu2 = new LeakyReLU(n, 4, 64, 0.1);
    r.layer2a = new CNNBuffer(64, 4*nx, 4*ny);
    r.conv3 = new ConvTranspose2D421(n, 4, 64, 64, r.w03_64_64_4_4, r.b03_64);
    r.layer3 = new CNNBuffer(64, 8*nx, 8*ny);
    r.relu3 = new LeakyReLU(n, 8, 64, 0.1);
    r.layer3a = new CNNBuffer(64, 8*nx, 8*ny);
    r.conv4 = new ConvTranspose2D421(n, 8, 64, 64, r.w04_64_64_4_4, r.b04_64);
    r.layer4 = new CNNBuffer(64, 16*nx, 16*ny);
    r.relu4 = new LeakyReLU(n, 16, 64, 0.1);
    r.layer4a = new CNNBuffer(64, 16*nx, 16*ny);
    r.conv5 = new ConvTranspose2D421(n, 16, 64, 64, r.w05_64_64_4_4, r.b05_64);
    r.layer5 = new CNNBuffer(64, 32*nx, 32*ny);
    r.relu5 = new LeakyReLU(n, 32, 64, 0.1);
    r.layer5a = new CNNBuffer(64, 32*nx, 32*ny);
    r.conv6 = new ConvTranspose2D421(n, 32, 64, 48, r.w06_64_48_4_4, r.b06_48);
    r.layer6 = new CNNBuffer(48, 64*nx, 64*ny);
    r.relu6 = new LeakyReLU(n, 64, 48, 0.1);
    r.layer6a = new CNNBuffer(48, 64*nx, 64*ny);
    r.conv7 = new Conv2d311(n, 64, 48, 32, r.w07_32_48_3_3, r.b07_32);
    r.layer7 = new CNNBuffer(32, 64*nx, 64*ny);
    r.relu7 = new LeakyReLU(n, 64, 32, 0.1);
    r.layer7a = new CNNBuffer(32, 64*nx, 64*ny);
    r.conv8 = new Conv2d311(n, 64, 32, 3, r.w08_3_32_3_3, [0.0, 0.0, 0.0]);
    r.layer8 = new CNNBuffer(3, 64*nx, 64*ny);
}
...
window.onload = function () {
    ...
    renderer.fsConv2d311 = loadShaderSource("conv2d311.glsl");
    ...
    try {
        renderer.programConv2d311 = createShaderProgram(renderer.vsSource, renderer.fsConv2d311);
